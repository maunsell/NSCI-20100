...
function clearButton_Callback(hObject, eventdata, handles)
    if strcmp(get(handles.startButton, 'String'), 'Start')          % currently paused
        clearPlots(handles);                                        % clear immediately
    else
        doStop(handles);                                            % stop data collection
        clearPlots(handles);                                        % clear the plots and data
        doStart(handles);                                           % re-start data collection
...
%% doStart: start the data collection
function doStart(handles)
...
%% doStop: stop the data collection
function doStop(handles)
