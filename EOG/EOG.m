...
%     setThreshold(handles.saccades, str2double(get(handles.thresholdDPSText, 'string')));
    ...
    taskTimer = timer('Name', 'TaskTimer', 'ExecutionMode', 'fixedRate',...
        ...
        {@taskController, handles.visStim, handles.saccades, [handles.axes1 handles.axes2 handles.axes3 handles.axes4]});
...
function taskController(obj, events, visStim, saccades, daqaxes)
